...
formatter.step({
  "name": "Ketika user sudah berada pada halaman awal, user dapat melihat \"Swag Labs\"",
  "keyword": "When "
});
formatter.match({
  "location": "stepdefenitions.LoginStepDefenition.Ketika_user_sudah_berada_pada_halaman_awal_user_dapat_melihat(java.lang.String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.scenario({
  "name": "Sebagai pengguna setelah melakukan login saya dapat memfilter dengan benar  (positive case)",
  "description": "",
  "keyword": "Scenario",
  "tags": [
    {
